...
const PolicyPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-gray-200 pt-24 pb-16">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          >
            <div className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mt-6 bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent">
                Policies & Terms
              </h1>
